...
$profileImage = !empty($user['profile_picture']) ? "profilepic/user/" . $user['profile_picture'] : "profilepic/manage.jpeg";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["profile_picture"])) {
    ...
    $targetDir = "profilepic/user/"; // Ensure this folder exists
...
<body>
    <div class="sidebar">
        <a href="UHome.php" class="close-icon"><i class="fas fa-times"></i></a>
    ...
    <div id="profilepic-section" class="section" class="settings mb-3">
        ...
        <div id="personal-info-section" class="section">
            ...
            <form method="POST" action="ManageP.php" id="personalinfo">
        ...
        <div id="account-management-section" class="section">
            <h3>Account Management</h3>
            <form method="POST" action="ManageP.php" id="accountinfo">
                <div class="profile-field">
                    <label for="currentPassword">Current Password</label>
                    <?php if (!empty($errors['currentPassword'])): ?>
                        <div class="error-message"><?php echo $errors['currentPassword']; ?></div>
                    <?php endif; ?>
                    <input type="password" class="form-control <?php echo !empty($errors['currentPassword']) ? 'error-border' : ''; ?>" 
                ...
                <div class="profile-field">
                    ...
                    <?php endif; ?>
                    <input type="password" class="form-control <?php echo !empty($errors['newPassword']) ? 'error-border' : ''; ?>" 
        ...
        <div id="theme-selection-section" class="section">
            <h3>Theme Selection</h3>
            <form style="width: 500px;" id="themeForm" method="POST" action="ManageP.php">
                <div class="profile-field">
